...
public class UserController {
    ...
    public ResponseEntity<List<User>> getUsersOrderByFullname(@RequestParam(value="sort",
        ...
        List<User> result = userRepository.findAll(new Sort(new Sort.Order(sortDirection,"fullname")));
    ...
    public ResponseEntity<User> updateUser(@PathVariable("id") String id, @RequestBody User user) throws ServletException{
    ...
    public ResponseEntity<User> deleteUser(@PathVariable(value = "id") String id) throws ServletException {
        User user = userRepository.findOne(id);
        if (user == null)
            return new ResponseEntity(HttpStatus.NO_CONTENT);
