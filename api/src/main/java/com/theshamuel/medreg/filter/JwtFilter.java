...
public class JwtFilter extends GenericFilterBean {
    ...
    public void doFilter(final ServletRequest req,
        ...
        if ((authHeader == null || !authHeader.startsWith("Bearer ")) ) { //&& request.getMethod()!="OPTIONS"
            ((HttpServletResponse)res).sendError(403,"Missing or invalid Authorization header.");
        }else if (authHeader != null && authHeader.startsWith("Bearer ") ) { //&& request.getMethod()!="OPTIONS"
