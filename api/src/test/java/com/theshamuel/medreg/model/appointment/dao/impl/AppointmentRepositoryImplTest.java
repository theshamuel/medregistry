...
public class AppointmentRepositoryImplTest extends BaseRepositoryImplTest{
    ...
    public void testFindReservedAppointmentsByDoctorAndDate(){
        List<Appointment> actual = appointmentRepositoryImpl.findReservedAppointmentsByDoctorAndDate(docIvanov,LocalDate.now());
        assertThat(actual.size(),is(2));
        assertThat(actual,hasItems(appointmentDocIvanov1,appointmentDocIvanov1));

        actual = appointmentRepositoryImpl.findReservedAppointmentsByDoctorAndDate(docSidorov,LocalDate.now());
    ...
    public void testFindReservedAppointmentsByDateEventAfterTimeEvent(){
        List<Appointment> actual = appointmentRepositoryImpl.findReservedAppointmentsByDateEventAfterTimeEvent(LocalDate.of(2018,01,01));
        assertThat(actual.size(),is(1));
        assertThat(actual,hasItems(appointmentDocPetrov));

        actual = appointmentRepositoryImpl.findReservedAppointmentsByDateEventAfterTimeEvent(LocalDate.of(2018,01,02));
        assertThat(actual,is(Collections.emptyList()));
    ...
    public void testFindReservedAppointmentsByDoctor(){
        List<Appointment> actual = appointmentRepositoryImpl.findReservedAppointmentsByDoctor(docIvanov);
        assertThat(actual.size(),is(2));
        assertThat(actual,hasItems(appointmentDocIvanov1,appointmentDocIvanov1));
    ...
    public void testFindByDateTimeEventAndDoctor(){
        Appointment actual = appointmentRepositoryImpl.findByDateTimeEventAndDoctor(docIvanov,LocalDate.now(),LocalTime.of(12,00));
        assertThat(actual,is(appointmentDocIvanov1));

        actual = appointmentRepositoryImpl.findByDateTimeEventAndDoctor(docIvanov,LocalDate.now(),LocalTime.of(13,00));
    ...
    public void createTestRecords() {
        ...
        docIvanov = new DoctorBuilder().name("Ivan").surname("Ivanov").middlename("Petrovich").id("d0001").contractor(0).isNotWork(0).excludeFromReport(0).position("therapist").build();
        docPetrov = new DoctorBuilder().name("Petr").surname("Petrov").middlename("Alexeevich").id("d0002").contractor(0).isNotWork(0).excludeFromReport(0).position("oculist").build();
        docSidorov = new DoctorBuilder().name("Oleg").surname("Sidorov").middlename("Olegovich").id("d0003").contractor(0).isNotWork(0).excludeFromReport(0).position("oculist").build();
        ...
        appointmentDocIvanov1 = new AppointmentBuilder().id("0001").doctor(docIvanov).dateEvent(LocalDate.now()).timeEvent(LocalTime.of(12,00)).build();
        appointmentDocIvanov2 = new AppointmentBuilder().id("0002").doctor(docIvanov).dateEvent(LocalDate.now()).timeEvent(LocalTime.of(12,15)).build();
        appointmentDocPetrov = new AppointmentBuilder().id("0003").doctor(docPetrov).dateEvent(LocalDate.of(2018,01,01)).timeEvent(LocalTime.of(8,15)).build();
