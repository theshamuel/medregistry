...
public class ClientRepositoryImplTest  extends BaseRepositoryImplTest {
    ...
    public void testIsUniqueClient(){
        Client newClient = new ClientBuilder().name("Oleg").surname("Olegov").passportSerial("1111").passportNumber("222222").address("Lenina 1").gender("men").build();
        boolean actual = clientRepositoryImpl.isUniqueClient(newClient);
        assertThat(actual,is(false));

        newClient = new ClientBuilder().name("Oleg").surname("Olegov").passportSerial("2222").passportNumber("222222").address("Lenina 1").gender("men").build();
    ...
    public void createTestRecords() {
        ...
        client3 = new ClientBuilder().name("Anna").surname("Sidorova").passportSerial("5555").passportNumber("555444").address("Req Squarer 118").gender("women").build();
